...
Use `docs/RULES_GENERIC.md` when creating/changing code style and implementation patterns.
Use `docs/RULES_PROGRAM.md` when changing business behavior for this OCI Starter demo.